...
namespace VkEngine {
  ...
  VkFramebuffer Framebuffer::getFramebuffer(const uint32_t imageIndex) const
  {
    return framebuffers[imageIndex];
  }

  VkDescriptorSet Framebuffer::getFramebufferImageDescriptorSet(const uint32_t imageIndex) const
  {
